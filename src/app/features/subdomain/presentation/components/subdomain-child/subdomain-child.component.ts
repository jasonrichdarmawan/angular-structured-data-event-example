...
@Component({
  selector: 'app-subdomain-child',
  templateUrl: './subdomain-child.component.html',
  styleUrls: ['./subdomain-child.component.scss']
})
export class SubdomainChildComponent implements OnInit {
  hostname: string;
  origin: string;
  href: string;
